...
struct DartsLoseView: View {
    @StateObject var dartsLoseModel =  DartsLoseViewModel()
                ...
                VStack {
                    ...
                    ZStack {
                        ...
                        Text("Continue for coins")
                            .SpicyRice(size: geometry.size.height * 0.02,
                                       outlineWidth: 0.5)
                        ...
                        Button(action: {
                            ...
                            ZStack {
                                ...
                                Text("BUY")
                                    .SpicyRice(size: geometry.size.height * 0.05,
                                               outlineWidth: 1)
                                ...
                                ZStack {
                                    ...
                                    Text("X3")
                                        .SpicyRice(size: geometry.size.height * 0.028,
                                                   outlineWidth: 0.8)
...
#Preview {
    @ObservedObject var router = Router()
    return DartsLoseView(router: router)
}
